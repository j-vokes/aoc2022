...
for instruction in instructions:
  transfer = inventory[instruction["source"]][-instruction["count"]:]
  del inventory[instruction["source"]][-instruction["count"]:]
  inventory[instruction["dest"]] = inventory[instruction["dest"]] + (transfer)
